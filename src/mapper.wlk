...
object n2 {
    ...
    [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
     [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
     [_,_,_,m,m,m,m,_,_,_,_,_,_,_,_,_,_],
     [_,_,_,m,_,_,m,m,m,m,_,_,_,_,_,_,_],    
     [_,_,_,m,_,_,m,_,_,m,_,_,_,_,_,_,_],
     [_,_,_,m,_,_,p,_,_,m,_,_,_,_,_,_,_],
     [_,_,_,m,m,caa,m,m,cab,m,m,m,m,_,_,_,_],
     [_,_,_,m,_,cv,_,_,_,_,_,_,m,_,_,_,_],         
     [_,_,_,m,m,_,m,m,_,m,m,_,m,_,_,_,_],
     [_,_,_,m,bv,_,_,_,_,_,_,_,m,_,_,_,_],
     [_,_,_,m,m,m,m,m,m,m,m,m,m,_,_,_,_],         
     [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],        
     [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]        
    ].reverse()
...
object n7 {
    ...
    [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
     [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],         
     [_,_,_,_,_,_,_,_,_,m,m,m,_,_,_,_,_],
     [_,_,m,m,m,m,_,m,m,m,_,_,m,m,_,_,_],
     [_,_,m,p,_,_,m,_,_,_,_,_,_,m,_,_,_],    
     [_,_,m,_,cv,_,cad,_,_,_,m,_,_,m,_,_,_],
     [_,_,m,caa,m,m,m,m,m,_,_,_,_,m,_,_,_],
     [_,_,m,_,_,_,cai,v,_,m,_,_,_,m,_,_,_],         
     [_,_,m,_,v,bv,m,_,_,cai,_,_,_,m,_,_,_],
     [_,_,m,m,m,m,m,m,m,m,m,m,m,m,_,_,_],
     [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
     [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
     [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]  
    ].reverse()
